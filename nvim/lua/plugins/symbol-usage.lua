        ...
        config  = function()
                ...
                local function text_format(symbol)
                        ...
                        if symbol.definition then
                                ...
                                table.insert(res,
                                             { icons.LspDef .. separator .. tostring(symbol.definition), "SymbolUsageDef" })
                                table.insert(res, { empty, "SymbolUsageDef" })
                        end
                        ...
                        if symbol.references then
                                ...
                                table.insert(res, { empty, "SymbolUsageDef" })
                                table.insert(res,
                                             { icons.LspRef .. separator .. tostring(symbol.references), "SymbolUsageRef" })
                                table.insert(res, { empty, "SymbolUsageDef" })
                        end
                        ...
                        if symbol.implementation then
                                ...
                                table.insert(res, { empty, "SymbolUsageDef" })
                                table.insert(res,
                                             { icons.LspImpl .. separator .. tostring(symbol.implementation), "SymbolUsageImpl" })
                                table.insert(res, { empty, "SymbolUsageDef" })
                        end
