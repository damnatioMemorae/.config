...
local customCol = function(C)
        return {
                ...
                FancyDiagnosticDefaultBorder = { fg = C.crust, bg = C.overlay2 },
                FancyDiagnosticError         = { fg = C.red, bg = C.mantle },
                FancyDiagnosticErrorIcon     = { bg = C.red },
                FancyDiagnosticErrorBorder   = { fg = C.crust, bg = C.red },
                FancyDiagnosticWarn          = { fg = C.yellow, bg = C.mantle },
                FancyDiagnosticWarnIcon      = { bg = C.yellow },
                FancyDiagnosticWarnBorder    = { fg = C.crust, bg = C.yellow },
                FancyDiagnosticInfo          = { fg = C.sky, bg = C.mantle },
                FancyDiagnosticInfoIcon      = { bg = C.sky },
                FancyDiagnosticInfoBorder    = { fg = C.crust, bg = C.sky },
                FancyDiagnosticHint          = { fg = C.teal, bg = C.mantle },
                FancyDiagnosticHintIcon      = { bg = C.teal },
                FancyDiagnosticHintBorder    = { fg = C.crust, bg = C.teal },
                --]]
                ...
                Search                       = { fg = spark, bg = C.base, reverse = true },
                ...
                LspReferenceText        = { bg = C.mantle, bold = true },
                ...
                MasonHighlightBlockBold = { fg = spark, bg = C.mantle, bold = false },
