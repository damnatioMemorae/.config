...
local customCol = function(C)
        return {
                ...
                Folded                     = { fg = C.overlay1, bg = C.mantle },
                ...
                -- Search                                       = { fg = colors.ivory, reverse = true },
                Search                     = { fg = colors.spark, bg = C.base, reverse = true },
                ...
                ["@method"]                     = { fg = colors.ivory, bg = "none" },
                ["@namespace"]                  = { fg = colors.ivory, bg = "none" },
                ...
                ["@variable.member"]            = { fg = colors.ivory, bg = "none" },
                ...
                -- BlinkCmpMenuSelection     = { fg = C.crust, bg = colors.ivory, bold = false },
                ...
                SnacksIndentScope       = { fg = colors.ivory },
