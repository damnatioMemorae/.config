...
local multimedia = {
        ...
        { "F7",      script("lua/screenshot.lua s flameshot", "lua"),           { locked = true } },
...
local navigation = {
        ...
        { "<D-C-h>",            dsp.window.move({ direction = "left" }),                { locked = true, repeating = true } },
        { "<D-C-j>",            dsp.window.move({ direction = "down" }),                { locked = true, repeating = true } },
        { "<D-C-k>",            dsp.window.move({ direction = "up" }),                  { locked = true, repeating = true } },
        { "<D-C-l>",            dsp.window.move({ direction = "right" }),               { locked = true, repeating = true } },

        { "<D-A-h>",            dsp.window.resize({ x = -10, y = 0, relative = true }), { locked = true, repeating = true } },
        { "<D-A-j>",            dsp.window.resize({ x = 0, y = -10, relative = true }), { locked = true, repeating = true } },
        { "<D-A-k>",            dsp.window.resize({ x = 0, y = 10, relative = true }),  { locked = true, repeating = true } },
        { "<D-A-l>",            dsp.window.resize({ x = 10, y = 0, relative = true }),  { locked = true, repeating = true } },

        { "<D-h>",              dsp.focus({ workspace = "-1" }),                        { locked = true, repeating = true } },
        { "<D-l>",              dsp.focus({ workspace = "+1" }),                        { locked = true, repeating = true } },

        { "<D-left>",           dsp.window.move({ workspace = "-1" }),                  { locked = true, repeating = true } },
        { "<D-right>",          dsp.window.move({ workspace = "+1" }),                  { locked = true, repeating = true } },
