local window_rules = {
        ...
        { size = "960 540",                   match = { title = "Save As.*" } },
        { center = true,                      match = { title = "Save As.*" } },

        { workspace = "special:magic silent", match = { class = "discord" } },

        { float = true,                       match = { class = "com.yazi.open" } },
        { size = "960 540",                   match = { class = "com.yazi.open" } },
        { center = true,                      match = { class = "com.yazi.open" } },
...
local workspace_rules = {
        { workspace = "special:magic", layout = "scrolling" },
        { workspace = "special:magic", gaps_out = 10 },
        { workspace = "special:magic", gaps_in = 0 },
}
